...
const Menu = () => {
            ...
            <li>
                <NavLink
                    ...
                    className={({ isActive }) =>
                        ...
                        } px-4 py-2 font-semibold hover:bg-rose-400 rounded-lg cursor-pointer`}>
                    Login
                </NavLink>
            </li>
            <li>
    ...
    let AuthenticatedUser = () => {
        ...
        {role === "admin" && (<li><NavLink to="/admin" end className={({ isActive }) =>
                        ...
                        } px-4 py-2 font-semibold hover:bg-rose-400 rounded-lg cursor-pointer flex gap-2 items-center`}>Admin</NavLink></li>)}
            <li>
                <NavLink
                    to={"/user/profile"}
                    className={({ isActive }) =>
                        `${isActive ? "bg-rose-300" : ""
                        } px-4 py-2 font-semibold hover:bg-rose-400 rounded-lg cursor-pointer flex gap-2 items-center`}>
            ...
            <li>
                <button
                    onClick={() => {logout()}}
                    className={
                        `px-4 py-2 font-semibold hover:bg-red-600 rounded-lg cursor-pointer flex gap-2 justify-evenly items-center`}>
                    <span>Logout</span>
