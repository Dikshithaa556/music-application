  ...
  let handleSubmit = async(e) => {
    ...
    try {
      ...
      if(albumThumbnail){
        ...
        //? Convert Album Thumbnail into binary data
        let albumData = new FormData();
        albumData.append("file",albumThumbnail);
        albumData.append("upload_preset","music_albums");
        albumData.append("cloud_name","dhepvjwrn")

        //?Upload album thumbnail to the cloudinary
        let response = await fetch("https://api.cloudinary.com/v1_1/dhepvjwrn/upload",
          {
            method:"POST",
            body:albumData
          }
          ...
          <div className="flex justify-around py-2">
            <div className="w-[350px] flex flex-col">
              ...
              <input
                ...
                onChange={handleAlbumInputChange}
                placeholder="Enter album release data"
              />
            </div>
            <div className="w-[350px] flex flex-col">
              <label
                  ...
                  <div className="flex justify-around py-2">
                    <div className="w-[530px] flex flex-col">
                      ...
                      <input
                        ...
                        accept="image/*"
                        placeholder="Upload song thumbnail"
                      />
                    </div>
                    <div className="w-[530px] flex flex-col">
                      <label
