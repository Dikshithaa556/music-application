            ...
            <article className='w-[30%] bg-gray-700 p-5 rounded-xl'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='flex flex-col mb-1 p-3 relative'>
                        ...
                        <input onChange ={handleInputChange} type="email" id="email" placeholder='Enter your email' className='outline-none border border-gray-500 p-2 rounded-lg' name="email" value={email}/>
