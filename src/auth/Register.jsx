...
const Register = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try{
      ...
      createUserWithEmailAndPassword(__AUTH)
      ...
      //! Updata profile name and photo url which is not updated by default
      updateProfile(registeredUser.user,{
        displayName:username,
        photoURL:"https://cdni.iconscout.com/illustration/premium/thumb/woman-profile-illustration-download-in-svg-png-gif-file-formats--young-female-girl-avatar-portraits-pack-people-illustrations-6590622.png"
      })
      ...
      <article className='w-[30%] bg-gray-700 p-5 rounded-xl'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='flex flex-col mb-1 p-3'>
            ...
            <input type="text" id="username" placeholder='Enter your name' className='outline-none border border-gray-500 p-2 rounded-lg' name = "username" value={username} onChange={handleInputChange}/>
          </div>
          <div className='flex flex-col mb-1 p-3'>
            <label htmlFor="" className='font-semibold text-lg mb-1'>Email</label>
            <input type="email" id="email" placeholder='Enter your email' className='outline-none border border-gray-500 p-2 rounded-lg' name="email" value={email} onChange={handleInputChange}/>
          </div>
          ...
          <div className='flex flex-col mb-1 p-3 relative'>
            ...
            <input type={showPassword2 ? "text" : "password"} id="confirmPassword" placeholder='Confirm your Password' className='outline-none border border-gray-500 p-2 rounded-lg' name="confirmPassword" value={confirmPassword} onChange={handleInputChange}/>
